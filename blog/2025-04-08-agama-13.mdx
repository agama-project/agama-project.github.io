...
First of all, there is nothing like an unique hostname since a machine can have different
...
## Register extensions from SUSE Customer Center {#extensions}
...
## Selection of individual packages to install {#packages}
...
The configuration is usually indicated by an URL that is passed to the installer. But AutoYaST URLs
...
Going further into the role of Agama as an AutoYaST successor, you may now that AutoYaST allows
