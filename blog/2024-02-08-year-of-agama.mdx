...
See more details at [this Github discussion](https://github.com/agama-project/agama/discussions/1000),
...
we updated the [document](https://github.com/agama-project/agama/blob/master/doc/storage_ui.md) that
