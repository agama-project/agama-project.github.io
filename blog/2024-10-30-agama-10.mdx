...
[warning](#free-space-warning) below.
...
in automatic installations. Reusing volume groups or logical volumes is not supported.
...
Those normally points to the official SUSE/openSUSE installation repositories.
