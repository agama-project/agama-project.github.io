...
0.8](2023-03-30-d-installer-0-8.mdx). It was still called D-Installer back then!
...
<SmallImageBox>
  ![](../static/img/blog/2023-08-21/disk.png)
  ![](../static/img/blog/2023-08-21/size.png)
  ![](../static/img/blog/2023-08-21/storage.png)
</SmallImageBox>

Also related to the selection of target devices, now it's possible to interactively
[configure zFCP devices](https://github.com/agama-project/agama/pull/634), in addition to the options
...
found issues that is described on [this pull request](https://github.com/agama-project/agama/pull/540).

The command line interface also received several enhancement with better [error
reporting](https://github.com/agama-project/agama/pull/659) and improved visualization of the
[installation progress](https://github.com/agama-project/agama/pull/653). Not to mention the possibility
