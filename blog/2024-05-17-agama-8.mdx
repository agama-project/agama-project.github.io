...
[previous post](2024-02-08-year-of-agama.mdx) we exposed the first two steps of
...
discussion](https://github.com/agama-project/agama/discussions/1000), we got powerful reasons to rethink
...
[improved](https://github.com/agama-project/agama/pull/1007) the form to edit a file system. On the other
hand, Balsa Asanovic continues growing his already impressive contribution to Agama with
[better visualization](https://github.com/agama-project/agama/pull/886) of the installation issues and
[enhancements](https://github.com/agama-project/agama/pull/1122) in the interface to create a user.
