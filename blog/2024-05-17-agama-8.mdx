...
title: Releasing version 8
description: Goodbye Cockpit, hello HTTP interface
tags:
  - release
---

The YaST Team is back with more news about [Agama](https://github.com/agama-project/agama). On our
[previous post](2024-02-08-year-of-agama.mdx) we exposed the first two steps of our roadmap for
2024: a more powerful user interface for the storage setup and a new Cockpit-free architecture with
a better API for external callers. Now we are proud to announce Agama 8, delivering initial versions
of both features.
...
As explained at the mentioned blog post and detailed at
[this Github discussion](https://github.com/agama-project/agama/discussions/1000), we got powerful
reasons to rethink Agama's architecture, getting rid of Cockpit and switching from D-Bus to HTTP as
main communication protocol between the different Agama components.
...
![Screenshot of the storage proposal](../static/img/blog/2024-05-17/storage.png)
...
[improved](https://github.com/agama-project/agama/pull/1007) the form to edit a file system. On the
other hand, Balsa Asanovic continues growing his already impressive contribution to Agama with
[better visualization](https://github.com/agama-project/agama/pull/886) of the installation issues
and [enhancements](https://github.com/agama-project/agama/pull/1122) in the interface to create a
user.
...
The easiest way to get your hands on Agama 8 is to download one of the
[Agama Live ISO testing images](https://download.opensuse.org/repositories/systemsmanagement:/Agama:/Devel/images/iso/)
and boot it on a virtual or bare-metal machine. Bear in mind this is one of the most experimental
...
[tracked](https://github.com/agama-project/agama/issues?q=is%3Aissue+is%3Aopen+label%3Abug).
...
YaST Team will hold at [openSUSE Conference 2024](https://events.opensuse.org/conferences/oSC24). If
