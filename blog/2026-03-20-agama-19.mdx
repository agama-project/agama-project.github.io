...
installer. Agama 19 represents a quite significant architectural overhaul (see
[#2951](https://github.com/agama-project/agama/pull/2951) and
[#2998](https://github.com/agama-project/agama/pull/2998)), needed to leave all those
...
experience, based on a better overview page and a more useful confirmation dialog (see
[#2988](https://github.com/agama-project/agama/pull/2988),
[#3009](https://github.com/agama-project/agama/pull/3009) and
[#3025](https://github.com/agama-project/agama/pull/3025)), sets the direction
to follow.
...
[network](https://github.com/agama-project/agama/pull/2929).

Regarding network, there are two important changes. On the one hand, now the user interface
dynamicaly reacts to changes in the underlying system (see [#3285](https://github.com/agama-project/agama/pull/3285)).
For instance, when a new cable is plugged in or when a new WiFi adapter is connected. On the other hand,
...
installation modes (see [#3086](https://github.com/agama-project/agama/pull/3086)).

When installing the experimental pre-releases of SLES 16.1 or the corresponding version of SLES for
SAP Applications (see [#3146](https://github.com/agama-project/agama/pull/3146)), now it is possible
...
the live ISO that most of you use to execute Agama (see [#3192](https://github.com/agama-project/agama/pull/3192)).
