...
infrastructure or even in creating its own client application for Agama.

## Even more changes under the hood {#techdetails}
...
unvaluable effort to ensure a smoother experience to all users.
...
which aspects we should focus. So do not hesitate to report bugs through Bugzilla or to contact us
at the [Agama project at GitHub](https://github.com/agama-project/agama). Of course, if you prefer
to chat, you can find us as always at our `#yast` channel at [Libera.chat](https://libera.chat/).
