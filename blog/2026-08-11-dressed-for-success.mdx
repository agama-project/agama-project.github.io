...
[theming guide](https://github.com/agama-project/agama/blob/master/doc/theming.md), that comes along
with two ready-to-copy examples similar to the ones described above and even with a draft AI prompt
in case you want to outsource the fun.
...
[packaging guide](https://github.com/agama-project/agama/blob/master/doc/theming_packaging.md) walks
through it. It also includes a few things you may want to know, like how to make your installer
start in dark mode or how to preview the result without packaging anything by just copying two files
into a running installer (eg. over `scp`) and reloading the browser.
