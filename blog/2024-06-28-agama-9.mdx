...
[Agama 8](2024-05-17-agama-8.mdx) was a massive release. It took almost five months of work and, as
a result, Agama got a new HTTP API and a more powerful user interface for setting up storage
devices. Not that bad, uh?
...
![Screenshot of the network page](../static/img/blog/2024-06-28/network.png)
...
![Recording of the 'agama config edit' in action](../static/img/blog/2024-06-28/agama-config-edit.gif)
...
![Screenshot of the Live ISO console](../static/img/blog/2024-06-28/live-iso.png)
