...
Now the situation is more obvious in the main summary screen of the installer and in the software
selection section.

![Revamped software selection screen](../static/img/blog/2026-05-21/software.png)

We took the opportunity to rethink several aspect of the form used to select patterns. Now it works
...
starting the installation with the boot argument `inst.preview_systemd_boot=1`.
...
And talking about installations and network, you already know that by default Agama allows to
