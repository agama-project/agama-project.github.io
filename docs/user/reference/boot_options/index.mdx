...
- `inst.finish`: allows to change the behavior of Agama when the installation finishes.
  - `stop`: do nothing (default for the interactive installation). Agama web user interface shows a
    button to reboot the system and gives you a chance to download the logs.
