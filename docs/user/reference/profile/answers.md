...
| `software.unknown_gpg`                 | When a file is signed by an unknown key.                                                                                 | `Yes`, `No`, `Trust`, `Skip` | `id`: The key ID.<br />`filename`: The name of the signed file.                                                                                                           |
...
| `software.package_error.provide_error` | When a package failed to be provided, e.g., due to an IO error or signature verification failure.                        | `Retry`, `Ignore`, `Continue` | `package`: The name of the package.                                                                                                                                                                          |
