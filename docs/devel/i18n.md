...
The code in the Git `master` branch contains a new `TranslatedString` type. Use it whenever your
code expects a translated text, like in component parameters.
