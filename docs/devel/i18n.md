...
correct source location in the other repository.
...
There is a helper script [build_pot](https://github.com/agama-project/agama/blob/master/web/build_pot)
...
[index.html](https://github.com/agama-project/agama/blob/master/web/src/index.html) file. But there is no
...
The
[webpack-po-handler.js](https://github.com/agama-project/agama/blob/master/web/src/lib/webpack-po-handler.js)
...
6. The translation is included in the respective PO file in the
   [agama-weblate](https://github.com/agama-project/agama-weblate) repository.
7. The PO file in the [agama](https://github.com/agama-project/agama/tree/master/web/po) repository is up
